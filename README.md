...
### Task Allocation
- **Dean:** Design and implement core classes like `User`, `Entry`, `Navigation`, and methods for data and file management.
- **Hermanus:** Implement data reading functionality.
- **Jan-Paul:** Design and implement the `Calculation` class.
- **Stiaan:** Implement reporting functionality, file I/O, and threading with custom alerts.
...
## 9. References
*References will be added as the project progresses.*

---

## 10. Appendices
*Any additional resources or information will be added here.*
